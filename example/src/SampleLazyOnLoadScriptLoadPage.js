...
const SampleLazyOnLoadScriptLoadPage = () => {
  const options = {
    fluid: true,
    autoplay: false,
    aspectRatio: '16:9',
    scriptLoadstrategy: 'lazyOnLoad',
      ...
      <div className="row">
        <div className="col-12">
          ...
          <section className="mt-4 mb-4">
            ...
            <p>
              This player is created with fluid layout mode, lazy on load script load, and before interactive script load, and setting aspect ratio to 16:9.
            </p>
...
export default SampleLazyOnLoadScriptLoadPage
